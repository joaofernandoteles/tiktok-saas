...
app.post('/api/tiktok/connect', authenticateToken, (req, res) => {
    const TIKTOK_CLIENT_KEY = process.env.TIKTOK_CLIENT_KEY || 'sbaw6425axydldhe4q';
...
app.get('/api/tiktok/callback', async (req, res) => {
    ...
    const userId = state;
    const TIKTOK_CLIENT_KEY = process.env.TIKTOK_CLIENT_KEY || 'sbaw6425axydldhe4q';
    const TIKTOK_CLIENT_SECRET = process.env.TIKTOK_CLIENT_SECRET || '6dKM0HVunc88luaZ0fYTuC7aPCqRuJdn';
